...
public class SteamweedHerb extends Herb {

    {
        image = ItemSpriteSheet.STEAMWEED_HERB;
    }
    ...
    public void eatEffect(Hero hero) {
        ...
        GameScene.add(Blob.seed(hero.pos, 10, Steam.class));
    }

    @Override
    public String name() {
        return Messages.get(Steamweed.class, "name")+ " " + Messages.get(Herb.class, "herb_name");
    }
