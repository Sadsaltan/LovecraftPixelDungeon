...
public class BlandFruitBushPoisonParticle extends PixelParticle {

	public static final Factory FACTORY = new Factory() {
		@Override
		public void emit(Emitter emitter, int index, float x, float y ) {
			((BlandFruitBushPoisonParticle)emitter.recycle( BlandFruitBushPoisonParticle.class )).reset( x, y );
		}
		@Override
	...
	public BlandFruitBushPoisonParticle() {
		super();
