...
public class DewcatcherHerb extends Herb {

    {
        image = ItemSpriteSheet.DEWCATCHER_HERB;
    }
    ...
    @Override
    public String name() {
        return Messages.get(WandOfRegrowth.Dewcatcher.class, "name")+ " " + Messages.get(Herb.class, "herb_name");
    }
