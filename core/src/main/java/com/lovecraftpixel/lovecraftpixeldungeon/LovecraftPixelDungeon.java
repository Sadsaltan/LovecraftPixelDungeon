...
public class LovecraftPixelDungeon extends Game {
	...
	public LovecraftPixelDungeon() {
		...
		com.watabou.utils.Bundle.addAlias(
				com.lovecraftpixel.lovecraftpixeldungeon.levels.rooms.special.MassGraveRoom.Bones.class,
				"com.lovecraftpixel.lovecraftpixeldungeon.levels.painters.MassGravePainter$Bones" );
		com.watabou.utils.Bundle.addAlias(
				com.lovecraftpixel.lovecraftpixeldungeon.levels.rooms.standard.RitualSiteRoom.RitualMarker.class,
				"com.lovecraftpixel.lovecraftpixeldungeon.levels.painters.RitualSitePainter$RitualMarker" );
		com.watabou.utils.Bundle.addAlias(
				com.lovecraftpixel.lovecraftpixeldungeon.levels.rooms.special.WeakFloorRoom.HiddenWell.class,
				"com.lovecraftpixel.lovecraftpixeldungeon.levels.painters.WeakFloorPainter$HiddenWell" );
		com.watabou.utils.Bundle.addAlias(
				com.lovecraftpixel.lovecraftpixeldungeon.levels.rooms.Room.class,
				"com.lovecraftpixel.lovecraftpixeldungeon.levels.Room" );
		com.watabou.utils.Bundle.addAlias(
				com.lovecraftpixel.lovecraftpixeldungeon.items.weapon.melee.Shortsword.class,
				"com.lovecraftpixel.lovecraftpixeldungeon.items.weapon.melee.NewShortsword" );
		
		//v0.6.0a
		com.watabou.utils.Bundle.addAlias(
				com.lovecraftpixel.lovecraftpixeldungeon.items.food.SmallRation.class,
				"com.lovecraftpixel.lovecraftpixeldungeon.items.food.OverpricedRation" );
