...
public class RotberryHerb extends Herb {

    {
        image = ItemSpriteSheet.ROTBERRY_HERB;
    }
    ...
    @Override
    public String name() {
        return Messages.get(Rotberry.class, "name")+ " " + Messages.get(Herb.class, "herb_name");
    }
