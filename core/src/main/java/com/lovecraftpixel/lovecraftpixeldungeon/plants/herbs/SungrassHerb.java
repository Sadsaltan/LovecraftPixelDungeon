...
public class SungrassHerb extends Herb {
    ...
    {
        image = ItemSpriteSheet.SUNGRASS_HERB;
    }
    ...
    public void eatEffect(Hero hero) {
        ...
        hero.increaseMentalHealth(hero.MHT);
        hero.HP = hero.HT;
        hero.gainKnowl(hero.maxKnowl());
    }

    @Override
    public String name() {
        return Messages.get(Sungrass.class, "name")+ " " + Messages.get(Herb.class, "herb_name");
    }
