...
public class FreezeTime extends Armor.Glyph {

	private static ItemSprite.Glowing FAINT_YELLOW = new ItemSprite.Glowing( 0x7E8052 );
		...
		if (Random.Int( level + 3 ) >= 2) {
			...
			if (RandomL.randomBoolean()) {
				if(attacker == Dungeon.hero){
					...
					attacker.sprite.showStatus(CharSprite.POSITIVE, Messages.get(TimeFreezing.class, "zawarudo"));
					GLog.p(Messages.get(TimeFreezing.class, "timestops"));
				}
			}
